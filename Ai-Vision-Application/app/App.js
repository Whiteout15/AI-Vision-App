...
export default function App() {
  ...
  // The useEffect hook is used to run code after the component has rendered.
  ...
  // If isLoading is true, return the LoadingScreen component,
  //otherwise return the NavigationContainer component
  if (isLoading) {
