...
const LetterTest: React.FC = () => {
  ...
  const defaultNumberOfCharacters = numberOfCharacters || 5;
  const [randomString, setRandomString] = useState(
    generateRandomString(defaultNumberOfCharacters)
  );
  ...
  useEffect(() => {
    console.log("Default Number of Characters:", defaultNumberOfCharacters);
  ...
  const increaseFontSize = () => {
    if (visualAcuityIndex < visualAcuityMeasurements.length - 1) {
      ...
      setRandomString(generateRandomString(defaultNumberOfCharacters));
    }
  };
  ...
  const updateRandomIcons = () => {
    ...
    if (newCount > defaultNumberOfCharacters) {
      endTest();
    } else {
